...
class LastMatchFragment : BaseFragment(), EventView.MainView {
    ...
    override fun onCreateView(
        ...
        EventPresenter(this, apiService).getPreviousMatch(id)
        return view
    ...
    override fun onEventLoaded(events: List<Events>) {
        initRecyclerView(recycler_view_last_match, events)
    }
